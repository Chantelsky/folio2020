    ...
    <main>
      ...
      <div className={style.projectContainer}>
        ...
        <div className={style.project}>
          ...
          <div className={style.title}>
            <h3>React Apps</h3>
            <p>20 React Apps to improve my skills</p>
          </div>
          <div className={style.imageWrapper}>
            <a href="/reactapps">
              <Img fluid={props.data.reactapps.childImageSharp.fluid} />
            </a>
          </div>
          <div className={style.date}>
        ...
        <div className={style.project}>
          ...
          <div className={style.imageWrapper}>
            <a href="/bookmark">
              <Img fluid={props.data.bookmark.childImageSharp.fluid} />
            </a>
          </div>
          <div className={style.date}>
            <p>2019.10.11</p>
...
export const project = graphql`
  query {
    ...
    reactapps: file(relativePath: { eq: "infinite-img.png" }) {
      ...projectImage
    }
